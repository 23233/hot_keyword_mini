...
export const SDUI_STYLE_TOKENS = new Set([
  ...
  'border/none', 'border/subtle', 'border/strong', 'radius/none', 'radius/sm', 'radius/md', 'radius/lg', 'radius/full',
  'space/y-0', 'space/y-2', 'space/y-4', 'space/y-6', 'space/y-8', 'space/y-10', 'space/y-12',
  'padding/none', 'padding/0', 'padding/2', 'padding/4', 'padding/6', 'padding/8',
  ...
  'accent/blue', 'accent/ink', 'accent/amber', 'elevation/none', 'elevation/sm', 'elevation/md', 'media/rounded'
])
